...
print(GREEN + "get_vida_owner_transaction_fee_share:" + RESET, sdk.get_vida_owner_transaction_fee_share())
...
print(GREEN + "get_vida_id_claiming_fee:" + RESET, sdk.get_vida_id_claiming_fee())
