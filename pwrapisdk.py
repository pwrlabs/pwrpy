...
class BlockchainAPI:
    ...
    @staticmethod
    def get_rpc_node_url():
        return BlockchainAPI.__PRC_NODE_URL
    ...
    def broadcast_txn(txn):
        try:
            url = BlockchainAPI.__PRC_NODE_URL + "/broadcast/"
            headers = {
                "Accept": "application/json",
                "Content-type": "application/json"
            }
    ...
    def get_nonce_of_address(address):
        try:
            url = BlockchainAPI.__PRC_NODE_URL + "/nonceOfUser/?userAddress=" + address
            headers = {
                "Accept": "application/json",
                "Content-type": "application/json"
            }
    ...
    def get_balance_of_address(address):
        try:
            url = BlockchainAPI.__PRC_NODE_URL + "/balanceOf/?userAddress=" + address
            headers = {
                "Accept": "application/json",
                "Content-type": "application/json"
            }
    ...
    def get_blocks_count():
        try:
            url = BlockchainAPI.__PRC_NODE_URL + "/blocksCount/"
            headers = {
                "Accept": "application/json",
                "Content-type": "application/json"
            }
    ...
    def get_block_by_number(block_number):
        try:
            response = requests.get(
                f"{BlockchainAPI.__PRC_NODE_URL}/block/?blockNumber={block_number}")
